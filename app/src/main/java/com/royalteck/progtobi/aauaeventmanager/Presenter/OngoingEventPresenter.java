...
import com.royalteck.progtobi.aauaeventmanager.Fragments.OngoingEventFrag;
...
public class OngoingEventPresenter {
    OngoingEventContract.View mview;
    private final APIService eventManApi;
    private UpEventAdapter meventAdapter;
    List<EventModel> mEventList;

    public OngoingEventPresenter(OngoingEventContract.View view) {
        mview =  view;
    ...
    private OngoingEventContract.View getView() {
        return mview;
    }
